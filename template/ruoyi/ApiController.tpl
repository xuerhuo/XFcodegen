package com.ruoyi.system.controller.{{module}};
...
@Api(tags = "{{table_des}}")
@RestController
@RequestMapping("/api/{{module}}/{{tableName}}")
public class {{TableName}}ApiController extends BaseController
{
    @Autowired
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:export')")
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:query')")
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:add')")
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('{{module}}:{{tableName}}Api:remove')")
